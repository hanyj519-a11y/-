...
function buildForwardHeaders(request, targetUrl) {
  ...
  const isZx = String(targetUrl?.hostname || '').toLowerCase() === 'zxai.work';
  const allowList = isZx
    ? ['authorization', 'content-type', 'accept']
    : ['authorization', 'content-type', 'accept', 'x-comfly-group', 'x-model-group', 'x-channel-group'];
